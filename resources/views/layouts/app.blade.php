...
<head>
    ...
    <meta name="keywords" content="Tienda de electronicos">
    <meta name="description" content="Tienda A especializa tienda virtual">
    <meta name="author" content="Erijo">
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="assets/images/logoA.png">
    <link rel="icon" type="image/png" sizes="32x32" href="assets/images/logoA.png">
...
<body>
    ...
    @include('components.menu_mobil')<!-- End .mobile-menu-container -->
